...
class CIL_EXPORTS _OutputArray;

class CIL_EXPORTS _InputArray {
 public:
  enum {
    KIND_SHIFT = 16,
...
class CIL_EXPORTS _OutputArray : public _InputArray {
 public:
  enum {
    DEPTH_MASK_8U = 1 << CIL_8U,
    DEPTH_MASK_8S = 1 << CIL_8S,
    DEPTH_MASK_16U = 1 << CIL_16U,
    DEPTH_MASK_16S = 1 << CIL_16S,
    DEPTH_MASK_32S = 1 << CIL_32S,
    DEPTH_MASK_32F = 1 << CIL_32F,
    DEPTH_MASK_64F = 1 << CIL_64F,
...
class CIL_EXPORTS _InputOutputArray : public _OutputArray {
 public:
  _InputOutputArray();
