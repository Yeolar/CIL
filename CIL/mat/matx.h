...
#include "CIL/traits.h"

namespace cil {

struct CIL_EXPORTS Matx_AddOp {};
struct CIL_EXPORTS Matx_SubOp {};
struct CIL_EXPORTS Matx_ScaleOp {};
struct CIL_EXPORTS Matx_MulOp {};
struct CIL_EXPORTS Matx_DivOp {};
struct CIL_EXPORTS Matx_MatMulOp {};
struct CIL_EXPORTS Matx_TOp {};
...
class Matx {
 public:
  enum {
    ...
    cols = n,
    channels = rows * cols,
    type = CIL_MAKETYPE(depth, channels),
    shortdim = (m < n ? m : n)
  };
  ...
  Matx(_Tp v0, _Tp v1, _Tp v2, _Tp v3, _Tp v4, _Tp v5, _Tp v6, _Tp v7, _Tp v8, _Tp v9, _Tp v10, _Tp v11, _Tp v12, _Tp v13);  //!< 1x14, 2x7, 7x2 or 14x1 matrix
...
template <typename _Tp, int m, int n>
inline Matx<_Tp, m, n>::Matx(
    _Tp v0, _Tp v1, _Tp v2, _Tp v3, _Tp v4, _Tp v5, _Tp v6) {
...
template <typename _Tp, int m, int n>
inline Matx<_Tp, m, n>::Matx(
    _Tp v0, _Tp v1, _Tp v2, _Tp v3, _Tp v4, _Tp v5, _Tp v6, _Tp v7) {
...
template <typename _Tp, int m, int n>
inline Matx<_Tp, m, n>::Matx(
    _Tp v0, _Tp v1, _Tp v2, _Tp v3, _Tp v4, _Tp v5, _Tp v6, _Tp v7, _Tp v8) {
...
template <typename _Tp, int m, int n>
inline Matx<_Tp, m, n> Matx<_Tp, m, n>::diag(
...
template <typename _Tp, int m, int n>
inline Matx<_Tp, m, n>::Matx(const Matx<_Tp, m, n>& a,
...
template <typename _Tp, int m, int n>
template <int l>
inline Matx<_Tp, m, n>::Matx(const Matx<_Tp, m, l>& a,
